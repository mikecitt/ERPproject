...
namespace TrgovinskaRadnja.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        public AuthenticationController(IAuthenticationService authenticationService, IUserService userService, JwtSettings jwtSettings,TrgovinskaRadnjaDataBaseContext context)
        {
